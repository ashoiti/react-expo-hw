  ...
  return (
    <View style={styles.container}>
      <View style={styles.text}>
        <Text>Por favor, selecione uma opção...</Text>
      </View>
      ...
      <View style={styles.actions}>
        ...
        <TouchableOpacity onPress={fetchRandomImageAsync} style={styles.button}>
          <Text style={styles.buttonLabel}>Gerar imagem</Text>
        </TouchableOpacity>
